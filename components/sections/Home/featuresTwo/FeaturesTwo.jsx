...
import featuresImg from "../../../../assets/features_img2.png"

export default function FeaturesTwo() {
  return (
    <section className="mt-[64px] md:mt-[100px]">
      <div className="inner_section flex-col-reverse flex md:flex-row gap-10 md:gap-3 items-center justify-between">
                ...
                <div className="self-stretch flex-col justify-start items-start gap-[30px] flex">
                    <div className="self-stretch flex-col justify-start items-start gap-[30px] flex">
                        <div className="self-stretch justify-center items-center flex">
                            <div className={`grow shrink basis-0 text-stone-950 text-3xl md:text-5xl font-semibold`}>Rewards program</div>
                        </div>
                    </div>
                    <div className="flex-col justify-start items-start gap-5 flex">
                        ...
                        <div className="justify-start items-start gap-2.5 flex">
                            ...
                            <div className={`grow shrink basis-0 text-stone-950 text-lg md:text-xl font-normal`}>Redemption Options</div>
                        </div>
                        <div className="justify-start items-start gap-2.5 flex">
                            <div className="w-6 h-6 p-1 bg-slate-300 rounded-3xl border justify-center items-center gap-1 flex">
                                <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className={`text-stone-950 text-lg md:text-xl font-normal`}>Maximizing Benefits</div>
                        </div>
                    </div>
                </div>
