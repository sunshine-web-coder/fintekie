    ...
    <div>
      <swiper-container ref={swiperElRef} slides-per-view="1">
        {sliderItems.map((item, i) => (
          <swiper-slide key={item.i}>
            <div className="flex flex-col items-center justify-start gap-5">
              <div className="flex items-center justify-center gap-2.5">
                <p className={`mx-auto max-w-[757px] text-center text-xl font-semibold text-stone-950 md:text-2xl`}>
                  “{item.quote}”
                </p>
              </div>
              <div className="flex flex-col items-center justify-start gap-2.5">
                ...
                <div className="flex flex-col items-center justify-start gap-1">
                  <span className={`text-center text-base font-semibold text-stone-950`}>
                    {item.name}
                  </span>
                  <span className={`text-center text-base font-light text-stone-950`}>
                    {item.role}
                  </span>
                </div>
              </div>
      ...
      <div className="mx-auto flex w-full items-center justify-between sm:max-w-[374px] mt-[50px]">
        <button className="flex items-start justify-start gap-2.5 rounded-[144px] bg-slate-100 p-2 md:p-5">
          <svg
            width="33"
            height="33"
            viewBox="0 0 33 33"
        ...
        <button className="flex rotate-180 items-start justify-start gap-2.5 rounded-[144px] bg-slate-100 p-2 md:p-5">
          <svg
            width="33"
            height="33"
            viewBox="0 0 33 33"
